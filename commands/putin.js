...
module.exports = {
	name: 'putin',
	description: 'Create Putin Spy Image',
	cooldown: 1,
	guildOnly: true,
	async execute(message, args) {
		...
		try {
			...
			const image = await new DIG.Poutine().getImage(user.displayAvatarURL({ dynamic: false, format: 'png' }))

			let attachment = new MessageAttachment(image, 'putin.png')
