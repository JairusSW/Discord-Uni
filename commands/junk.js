...
module.exports = {
	...
	async execute(message, args) {
		...
		try {
			...
			const image = await new DIG.Trash().getImage(user.displayAvatarURL({ dynamic: false, format: 'png' }))

			let attachment = new MessageAttachment(image, 'junk.png')
