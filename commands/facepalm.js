...
module.exports = {
	name: 'facepalm',
	description: 'Create Facepalm Image',
	cooldown: 1,
	guildOnly: true,
	async execute(message, args) {
		...
		try {
			...
			const image = await new DIG.Facepalm().getImage(user.displayAvatarURL({ dynamic: false, format: 'png' }))

			let attachment = new MessageAttachment(image, 'facepalm.png')
