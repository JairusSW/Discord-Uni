...
module.exports = {
	...
	async execute(message, args) {
		...
		try {
			...
			const image = await new DIG.Podium().getImage(user1.displayAvatarURL({ dynamic: false, format: 'png' }), user2.displayAvatarURL({ dynamic: false, format: 'png' }), user3.displayAvatarURL({ dynamic: false, format: 'png' }), user1.username, user2.username, user3.username)
