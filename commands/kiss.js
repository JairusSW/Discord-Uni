...
module.exports = {
	name: 'kiss',
	description: 'Create Kissing Image',
	cooldown: 1,
	guildOnly: true,
	async execute(message, args) {
		...
		try {
			...
			const image = await new DIG.Kiss().getImage(message.author.displayAvatarURL({ dynamic: false, format: 'png' }), user.displayAvatarURL({ dynamic: false, format: 'png' }))
